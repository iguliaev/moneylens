...
CREATE
OR REPLACE FUNCTION public.delete_bank_account_safe (p_bank_account_id UUID) RETURNS TABLE (ok BOOLEAN, in_use_count BIGINT) LANGUAGE plpgsql SECURITY DEFINER
SET
  search_path = '' AS $$
DECLARE
  v_uid uuid;
