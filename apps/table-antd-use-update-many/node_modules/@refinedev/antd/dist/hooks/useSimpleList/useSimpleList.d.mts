...
export type useSimpleListReturnType<TQueryFnData extends BaseRecord = BaseRecord, TSearchVariables = unknown, TData extends BaseRecord = TQueryFnData> = Omit<useTableReturnType<TData>, "tableQuery"> & {
 ...
 *
 */
export declare const useSimpleList: <TQueryFnData extends BaseRecord = BaseRecord, TError extends HttpError = HttpError, TSearchVariables = unknown, TData extends BaseRecord = TQueryFnData>({ resource, pagination: paginationFromProp, filters: filtersFromProp, sorters: sortersFromProp, onSearch, queryOptions, syncWithLocation, successNotification, errorNotification, liveMode: liveModeFromProp, onLiveEvent, liveParams, meta, dataProviderName, }?: useSimpleListProps<TQueryFnData, TError, TSearchVariables, TData>) => useSimpleListReturnType<TData, TSearchVariables>;
