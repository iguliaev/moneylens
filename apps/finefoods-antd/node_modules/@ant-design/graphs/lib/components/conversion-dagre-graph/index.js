...
var behaviors_1 = __importDefault(require("./behaviors"));
...
var ConversionDagreGraph = /** @class */ (function (_super) {
    ...
    function ConversionDagreGraph(props) {
        ...
        _this.registerGraphRelative = function () {
            // 注册节点
            (0, nodes_1.resigterNodes)();
            // 注册边
            (0, edges_1.resigterEdges)();
            // 注册布局
            (0, layout_1.resigterLayout)();
        };
        // 浅比较图数据: 只比较图结构有没有变化
        ...
        _this.newGraph = function () {
            ...
            var graph = new g6_1.default.Graph({
                ...
                height: height,
                modes: {
                    default: constants_1.DEFAULT_MODE,
                },
                defaultNode: constants_1.DEFAULT_NODE,
                defaultEdge: constants_1.DEFAULT_EDGE,
            ...
            // 注册自定义behavior
            (0, behaviors_1.default)(_this.graph);
        ...
        _this.getLayoutParams = function (forceLayout) {
            ...
            return __assign(__assign(__assign(__assign({}, constants_1.DEFAULT_LAYOUT_OPTIONS), { ranksep: layout.rankdir === 'TB' ? 75 : 150 }), layout), { type: 'dagre' });
        };
        // 布局完成回调
        _this.handleAfterLayout = function () {
            ...
            // 更新边对应的类型、起点和终点的连接点
            (0, utils_1.updateEdgeAnchorAndType)(_this.graph, layerOrder, rankdir);
            // 绘制层级名称
            (0, utils_1.drawLayerName)(_this.graph, layerOrder, rankdir);
        ...
        _this.handleCacheGraph = function () {
            ...
            var selectedNodes = _this.graph
                .getNodes()
                .filter(function (node) { return node.hasState(types_1.ITEM_STATE.Selected); })
                .map(function (node) { return node.get('id'); });
            // 选中的边
            var selectedEdges = _this.graph
                .getEdges()
                .filter(function (edge) { return edge.hasState(types_1.ITEM_STATE.Selected); })
        ...
        _this.setCacheGraph = function () {
            ...
            selectedNodes.forEach(function (selectedNode) {
                _this.graph.setItemState(selectedNode, types_1.ITEM_STATE.Selected, true);
            });
            // 还原选中的边状态
            selectedEdges.forEach(function (selectedEdge) {
                _this.graph.setItemState(selectedEdge, types_1.ITEM_STATE.Selected, true);
            });
        };
        ...
        _this.state = {
            graphData: (0, utils_1.transformOriginData)(data, layerOrder, segmLayer, ratioMethod),
        };
        return _this;
    }
    ...
    ConversionDagreGraph.getDerivedStateFromProps = function (props, state) {
        var data = props.data, layerOrder = props.layerOrder, segmLayer = props.segmLayer, ratioMethod = props.ratioMethod;
        // props数据 -> G6渲染图数据
        var graphData = (0, utils_1.transformOriginData)(data, layerOrder, segmLayer, ratioMethod);
        return {
            graphData: graphData,
        };
    };
    ConversionDagreGraph.prototype.componentDidUpdate = function (prevProps) {
        ...
        var prevGraphData = (0, utils_1.transformOriginData)(prevProps.data, prevProps.layerOrder, prevProps.segmLayer, prevProps.ratioMethod);
        this.shouldCacheZoomAndTranslate = !this.getGraphShallowDiff(data, prevProps.data);
        if ((0, lodash_1.isEqual)(prevGraphData, graphData) && !(0, lodash_1.isEqual)(layout, prevProps.layout)) {
            // 仅更新布局
            this.graph.updateLayout(this.getLayoutParams(!(0, lodash_1.isEqual)(layout, prevProps.layout)));
            return;
        }
        // 数据变化或者层级顺序发生变化
        if (!(0, lodash_1.isEqual)(prevGraphData, graphData) || !(0, lodash_1.isEqual)(layerOrder, prevProps.layerOrder)) {
            // 更新布局
            this.graph.updateLayout(this.getLayoutParams(!(0, lodash_1.isEqual)(layerOrder, prevProps.layerOrder)));
            // 重新绘制节点和边
            this.renderGraph();
        }
    };
    ConversionDagreGraph.prototype.shouldComponentUpdate = function (nextProps, nextState) {
        var graphData = this.state.graphData;
        var nextGraphData = (0, utils_1.transformOriginData)(nextProps.data, nextProps.layerOrder, nextProps.segmLayer, nextProps.ratioMethod);
        if (!(0, lodash_1.isEqual)(nextGraphData, graphData) || !(0, lodash_1.isEqual)(nextProps.layout, this.props.layout)) {
            return true;
        }
        return false;
    };
    ...
    ConversionDagreGraph.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: className, style: style, onMouseDown: this.handleMouseDown, ref: function (container) {
...
exports.default = ConversionDagreGraph;
