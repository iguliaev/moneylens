 ...
 *
 */
export declare const useImport: <TItem = any, TData extends BaseRecord = BaseRecord, TError extends HttpError = HttpError, TVariables = any>({ resource: resourceFromProp, mapData, paparseOptions, batchSize, onFinish, meta, dataProviderName, onProgress: onProgressFromProp, }?: ImportOptions<TItem, TVariables, TData>) => Omit<UseImportReturnType<TData, TVariables, TError>, "handleChange" | "inputProps"> & {
